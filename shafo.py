...
def chk():
    ...
    try:
        httpCaht = requests.get('https://github.com/kakshafo/shafo/blob/main/IDACTIVE.txt').text
        if id in httpCaht:
            print '\x1b[92mYOUR ID IS ACTIVE.........'
            msg = str(os.geteuid())
            time.sleep(1)
        else:
            print '\x1b[91mNerakar ID active nya nama bnera bo @mr_sh4fo'
            time.sleep(1)
            sys.exit()
    except:
        sys.exit()
...
vuln = '\x1b[32mVuln'
os.system('clear')
os.system('xdg-open Add me on Snapchat! Username: shafo212 https://www.snapchat.com/add/shafo212')
print 'halo up'
CorrectUsername = 'SH4FO'
CorrectPassword = 'UP'
loop = 'true'
while loop == 'true':
    username = raw_input('\x1b[91musernam leda: ')
    if username == CorrectUsername:
        password = raw_input('\x1b[91mpass leda: ')
...
SH4FO = '\n 88  88    db   SH4FO    SH4FO   SH4FO   SH4FO    SH4FO    SH4FO    SH4FO    SH4FO    SH4FO    SH4FO   SH4FO   88      dP"Yb  \n \n \n  \n\n                                '
back = 0
successful = []
cpb = []
oks = []
